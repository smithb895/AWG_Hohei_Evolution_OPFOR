...
_end setTriggerType "END6";
	...
	if __isBlue then {
		...
		ammobox3 = "USVehicleBox_EP1" createVehicleLocal getmarkerpos "ammob5";ammobox3 setpos getmarkerpos "ammob5"; __sleep;
	} else {
		...
		ammobox3 = "TKVehicleBox_EP1" createVehicleLocal getmarkerpos "ammob5";ammobox3 setpos getmarkerpos "ammob5"; __sleep;
	};
#else
	if __isBlue then {
		...
		ammobox3 = "USVehicleBox" createVehicleLocal getmarkerpos "ammob5";ammobox3 setpos getmarkerpos "ammob5"; __sleep;
	} else {
		ammobox1 = "RUVehicleBox" createVehicleLocal getmarkerpos "ammob1";ammobox1 setpos getmarkerpos "ammob1"; ammobox1 setdir 180; __sleep;
		ammobox2 = "RUVehicleBox" createVehicleLocal getmarkerpos "ammob3";ammobox2 setpos getmarkerpos "ammob2"; __sleep;
		ammobox3 = "RUVehicleBox" createVehicleLocal getmarkerpos "ammob5";ammobox3 setpos getmarkerpos "ammob5"; __sleep;
	};
#endif
ammobox1 addAction [localize "STR_a_sl" call XYellowText, "client\func\saveloadout.sqf"];
player reveal ammobox1;
ammobox3 addAction [localize "STR_a_sl" call XYellowText, "client\func\saveloadout.sqf"];
player reveal ammobox3;
...
{_x allowDamage false; [_x] call EVO_AmmoBox} forEach [ammobox1,ammobox2,ammobox3];
