...
__adddv(Chernarus);
#endif
diag_log format ["[AWG] Evolution v5.96a - Version Settings: %1 #######", e_version];
...
EVO_jetspawn_delay = 0;			//time in seconds
EVO_attackhspawn_delay = 0;			//time in seconds
...
EVO_Onmission = false;
EVO_sm_reward = 20;
EVO_firemission = true;			   	// Limits support to one request at a time.
...
switch (true) do {
	...
	case (!__ACEver and (__A2only or __COver)) : {
		EVO_pammo = ["30Rnd_762x39_AK47","30Rnd_762x39_AK47","30Rnd_762x39_AK47","30Rnd_762x39_AK47","30Rnd_762x39_AK47"/*,"PipeBomb"*/,"Laserbatteries","8Rnd_9x18_Makarov","8Rnd_9x18_Makarov","8Rnd_9x18_Makarov","8Rnd_9x18_Makarov"];
		EVO_pweapons = ["AK_47_M","Makarov","Laserdesignator","NVGoggles"];
	};
	case (__ACEver and __Takistan) : {
...
#ifdef __RED__
EVO_rank1_vecs = ["D30_RU","Mi17_Civilian","UAZ_AGS30_RU","BTR90","GAZ_Vodnik","BRDM2_INS","BMP2_INS","BRDM2_ATGM_INS","GAZ_Vodnik_HMG","Ural_ZU23_INS"];
EVO_rank2_vecs = ["T72_RU","BMP3","ZSU_INS","Mi17_Ins"];
EVO_rank3_vecs = ["GRAD_INS","GRAD_RU","T90","2S6M_Tunguska","Mi17_rockets_RU"];
EVO_rank4_vecs = ["Mi24_V","Mi24_P","Su25_Ins"];
EVO_rank5_vecs = ["Su39","Ka52Black","Ka52"];
EVO_rank6_vecs = ["Su34"];
#else
...
if __isBlue then {
		...
		EVO_e_aa = ["HMMWV_Avenger","ZSU_CDF"];
...
// Only listing opfor vehicles for lift in EVO Red.
d_helilift1_types = ["2S6M_Tunguska","BMP3","T72_RU","T90",
"BMP2_Ambul_INS","BMP2_INS","ZSU_INS",
"BTR90","GAZ_Vodnik","GAZ_Vodnik_HMG","GAZ_Vodnik_MedEvac","GRAD_RU","UAZ_AGS30_RU","UAZ_RU",
"Kamaz","KamazOpen","KamazReammo","KamazRefuel","KamazRepair",
"BRDM2_ATGM_INS","BRDM2_INS","UAZ_MG_INS","UAZ_SPG9_INS","Ural_ZU23_INS"];
...
// editor varname, unique number, true = respawn only when the chopper is completely destroyed, false = respawn after some time when no crew is in or chopper is destroyed
if (isServer) then {
	[[ch1,301,false,120],[ch2,302,false,120],[ch3,303,false,120]] execVM "server\x_helirespawn2.sqf";
	//[[ch3,303,false,240],[ch7,307,false,240]] execVM "server\x_helirespawn3.sqf";  // Not needed in RED
	[[ah12,308,true,10]] execVM "awg\x_awgespawn2.sqf";
};

// [ch4,304,false,120],[ch5,305,false,120],[ch6,306,false,120],
