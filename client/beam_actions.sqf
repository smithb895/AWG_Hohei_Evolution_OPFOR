...
switch _action do {
	...
	case 3:	{ //to farp germany
		player SetPos [(getMarkerPos "Marker_Farp_Ger" select 0)-15*sin(_dir),(getMarkerPos "Marker_Farp_Ger" select 1)-15*cos(_dir)];
	};
	case 4:	{ //to farp Czech
		player SetPos [(getMarkerPos "Marker_Farp_Czech" select 0)-15*sin(_dir),(getMarkerPos "Marker_Farp_Czech" select 1)-15*cos(_dir)];
	};
	case 5:	{ //to farp us
		player SetPos [(getMarkerPos "Marker_Farp_US" select 0)-15*sin(_dir),(getMarkerPos "Marker_Farp_US" select 1)-15*cos(_dir)];
	};
};